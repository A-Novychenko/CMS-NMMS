...
export interface ApiAboutMassageAboutMassage extends Schema.CollectionType {
  collectionName: 'about_massages';
  info: {
    singularName: 'about-massage';
    pluralName: 'about-massages';
    displayName: 'about_massage';
    description: '';
  };
  options: {
  ...
  attributes: {
    subtitle: Attribute.String & Attribute.Required & Attribute.Unique;
    ...
    createdBy: Attribute.Relation<
      'api::about-massage.about-massage',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiNewsPostNewsPost extends Schema.CollectionType {
  ...
  attributes: {
    title: Attribute.String & Attribute.Required & Attribute.Unique;
    short_descr: Attribute.Text & Attribute.Required;
    img_file_small: Attribute.Media;
    img_small: Attribute.String;
    img_file_big: Attribute.Media;
    img_big: Attribute.String;
    long_descr: Attribute.Text;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::about-massage.about-massage': ApiAboutMassageAboutMassage;
